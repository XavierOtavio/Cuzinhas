...
export default function Dashboard() {
  ...
  return (
    <div className="absolute inset-0 mx-32 my-16 grid grid-cols-12 grid-rows-6 gap-2">
      ...
      <div className="row-start-1 row-end-6 col-start-6 col-end-13 overflow-hidden overscroll-y-auto">
        <div className=" inset-x-32 inset-y-16 overflow-x-auto shadow-md sm:rounded-lg bg-stone-200">
          ...
          <table className="table-fixed w-full text-sm text-left text-stone-500 overflow-hidden overscroll-contain">
