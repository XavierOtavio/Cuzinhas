  ...
  return (
    <div className="absolute inset-0 mx-32 my-16 grid grid-cols-12 grid-rows-6 gap-2">
      ...
      <div className="row-start-4 row-end-5 col-start-1 col-end-5">
        <h1 classname="text-2xl font-medium">Performance de Vendas</h1>
        <p>
          <span class="text-2xl font-medium text-gray-900"> 24 470,96€</span>
          são os ganhos totais de vendas semanais. são
          <span class="text-2xl font-medium text-gray-900"> 16 875,47€</span>
          as despesas totais de vendas semanais.
        </p>
      </div>
