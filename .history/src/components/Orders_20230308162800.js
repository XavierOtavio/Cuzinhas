...
export default function Orders() {
  ...
  const statusBadge = (status) => {
    switch (status) {
      ...
      case "Scheduled":
        return (<span class="bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">Agendado</span>)
      case "Canceled":
        return (<span class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">Cancelado</span>)
      case "Refunded":
        return (<span class="bg-gray-100 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">Reembolsado</span>)
      default:
        return (<span class="bg-gray-100 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded">Não definido</span>)
    }
