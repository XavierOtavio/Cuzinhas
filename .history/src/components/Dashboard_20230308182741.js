  ...
  return (
    <div className="absolute top-0 left-0 right-0 ml-32">
      ...
      <div classname="grid grid-cols-12 grid-rows-2">
        <div classname="row-start-1 row-end-2 col-start-1 col-end-5 bg-red-600">
          <button class="flex flex-col rounded-lg border border-gray-100 bg-white p-6 my-3">
        ...
        <div className="row-start-2 row-end-3 col-start-6 col-end-9 bg-red-600">
