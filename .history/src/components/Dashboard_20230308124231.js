        ...
        <div>
          <div className="inline-flex h-16 w-16 items-center justify-center">
            ...
            >
              ...
              />
              <span className="absolute left-full whitespace-nowrap top-1/2 ml-4 float-left -translate-y-1/2 rounded bg-stone-900 px-2 py-1.5 text-xs font-medium text-stone-50 opacity-0 group-hover:opacity-100">
