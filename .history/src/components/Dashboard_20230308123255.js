            ...
            <nav aria-label="Main" className="flex flex-col p-2">
              <div className="py-4">
                ...
                >
                  ...
                  <span className="absolute left-full top-1/2 ml-4 -translate-y-1/2 rounded bg-stone-50 px-2 py-1.5 text-xs font-medium text-stone-900 opacity-0 group:opacity-100">
                    Dashboard
                  </span>
                </NavLink>
              </div>
