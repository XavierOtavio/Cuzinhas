...
export default function Orders() {
  ...
  const statusBadge = (status) => {
    switch (status) {
      case "PendingPayment":
        return (<span class="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-yellow-300">À espera de pagamento</span>
        );
        break;
      case "Assembling":
        return (<span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">Em instalação</span>);
        break;
      case "Scheduling":
