...
export default function Dashboard() {
  return (
    <div className="absolute top-0 left-0 right-0 ml-32">
      ...
      <button class="flex flex-col gap-4 rounded-lg border border-gray-100 bg-white p-6 w-3/12 my-2">
      ...
      <button class="flex flex-col gap-4 rounded-lg border border-gray-100 bg-white p-6 w-3/12 my-5">
