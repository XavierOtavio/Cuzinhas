      ...
      <div className="flex items-center justify-between pb-4">
        <div className="relative mx-2 mt-1 flex-1">
          <select
            ...
            className="peer block w-full appearance-none border-0 border-b-2 border-gray-300 bg-transparent px-0 py-2.5 text-sm text-gray-900 focus:border-red-900 focus:outline-none focus:ring-0 "
          >
